 ...
 * [bugfix] strengthened validation across encoding, decoding, adjacent-cell lookup, bounding boxes, collection statistics, Pandas Series detection, and visualization collection inputs; invalid values now fail consistently instead of producing misleading results or low-level errors.
 * [bugfix] decoding now accepts uppercase and mixed-case geohashes, and cardinal selectors preserve the caller's original geohash string.
 ...
 * [docs] dependency-free docstring examples are now verified as doctests.
